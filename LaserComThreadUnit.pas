...
procedure LaserComThread.Execute;
// --------------------------------
...
procedure LaserComThread.OpenCOMPort ;
// ----------------------------------------
...
procedure  LaserComThread.CloseCOMPort ;
// ----------------------
...
function LaserComThread.SendCommand(
...
function LaserComThread.ReceiveBytes(
